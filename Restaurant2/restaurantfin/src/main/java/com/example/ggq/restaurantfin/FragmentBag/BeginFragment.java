 ...
 * {@link BeginFragment.OnFragmentInteractionListener} interface
...
public class BeginFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        Glide.with(this).load("http://192.168.191.1:8080/Hotpotserver/img/begin.jpg")
                .skipMemoryCache(true)
                .diskCacheStrategy(DiskCacheStrategy.ALL)
                .into(new SimpleTarget<GlideDrawable>() {
                    @Override
                    public void onResourceReady(GlideDrawable resource, GlideAnimation<? super GlideDrawable> glideAnimation) {
                        view.findViewById(R.id.Begin_Backgrount).setBackground(resource);
                    }
                });
        return view;
    }
